    ...
    <div class="clear"></div>
    <div class="grid_12">
        <div class="footer"><a href="index.php">Le Moulin de la Grande Planche</a> - 81, rue des Fontaines, 89500 Marsangy - 03 86 96 99 11 - <script type="text/javascript" >mail2("boura.francine","alicedsl",14,"","boura.francine@aliceadsl.fr","alicedsl")</script>
            <noscript> boura.francine[remplacer par @]aliceadsl.fr</noscript></div>
    </div>
	<div class="clear"></div>
</div>
<!-- end .container_12 -->
 <div class="container_12" style="background:transparent;margin-top: 0px;margin-bottom : 0px">
...
<script type="text/javascript" src="/js/mylib-domready.js"></script>
</body>
</html>