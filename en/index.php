...
$title = 'Accueil';
$description = "";
$keywords = "chambre d'hote , bed and breakfast ,b&b,guest house, bourgogne , burgundy ,  sénonais , sens , b&b , France, Villeneuve, sur , Yonne , rural houses ";
$extraScripts = '';
...
<div class="grid_12" style="margin-bottom:25px">   
    ...
    <img src="/images/banners/banner_pic01.jpg" alt=""/>
</div>
...
<div class="grid_10 prefix_1 suffix_1" style="margin-bottom:25px">
    <p style="text-align: center;">
        Guest house 9 kilometers from Villeneuve-sur-Yonne and 15 kilometers from Sens<br/>
       Accomodation in a charming XIXth century mill.
    </p></div>
